...
import { useTheme, type ThemeType } from '../../../components/Theme/ThemeProvider';
...
export const AppearanceSection: React.FC<AppearanceSectionProps> = ({ searchQuery }) => {
    ...
    const showsTheme = matchesSearch(t('settings.appearance.theme')) ||
    ...
    const filteredThemes = searchQuery
        ? THEMES.filter(tItem => matchesSearch(t(tItem.nameKey)))
        : THEMES;
